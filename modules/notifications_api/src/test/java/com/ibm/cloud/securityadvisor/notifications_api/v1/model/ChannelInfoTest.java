...
/**
 * Unit test class for the ChannelInfo model.
 */
public class ChannelInfoTest {
  ...
  @Test
  public void testChannelInfo() throws Throwable {
    ChannelInfo channelInfoModel = new ChannelInfo();
    assertNull(channelInfoModel.getChannelId());
    assertNull(channelInfoModel.getStatusCode());
  }
}