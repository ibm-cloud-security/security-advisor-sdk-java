...
/**
 * Unit test class for the ChannelsList model.
 */
public class ChannelsListTest {
  ...
  @Test
  public void testChannelsList() throws Throwable {
    ChannelsList channelsListModel = new ChannelsList();
    assertNull(channelsListModel.getChannels());
  }
}