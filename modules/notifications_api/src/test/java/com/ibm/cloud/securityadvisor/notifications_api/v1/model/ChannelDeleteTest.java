...
/**
 * Unit test class for the ChannelDelete model.
 */
public class ChannelDeleteTest {
  ...
  @Test
  public void testChannelDelete() throws Throwable {
    ChannelDelete channelDeleteModel = new ChannelDelete();
    assertNull(channelDeleteModel.getChannelId());
    assertNull(channelDeleteModel.getMessage());
  }
}