...
# IBM Cloud Security Advisor Java SDK Version 1.1.2
...
--- | --- 
[IBM Cloud Security Advisor Findings API](https://cloud.ibm.com/apidocs/findings) | com.ibm.cloud.securityadvisor:findings_api:1.1.2
[IBM Cloud Security Advisor Notifications API](https://cloud.ibm.com/apidocs/notifications) | com.ibm.cloud.securityadvisor:notifications_api:1.1.2
...
##### Gradle
```gradle
'com.ibm.cloud:securityadvisor:1.1.2'
```
